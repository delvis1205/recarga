# 📖 README – Recarga Jogo Angola

## 🏷️ R.J.A | Morásio Digital
...
🔗 **Site funcional (ao vivo):** [https://recargajogoangola.shop](https://recargajogoangola.shop)
...
## 📦 Fluxo do Pedido
1. Cliente escolhe produto em `/index.html` → adiciona ao **carrinho**  
2. Ao finalizar, é redirecionado para `/formulario.html` com os itens do pedido  
3. Preenche dados (nome, e-mail, ID, nickname, pagamento)  
4. Dados são enviados para:
...
## 📞 Suporte
- WhatsApp: [973 929 712](https://wa.me/244973929712)  
